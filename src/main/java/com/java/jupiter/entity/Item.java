package com.java.jupiter.entity;
...
/**
 * The Item class act as a general item object that can represents stream, video and clip object,
 * determined by the "type" property.
 * The Item class has some setters because fields like type, url and gameId may not return from Twitch,
